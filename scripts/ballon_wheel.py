...
# 1) CARGA MODELO
# =========================
bundle = joblib.load(os.path.expanduser("data_analysis/models/ballon_wheel.joblib"))
...
# 2) LOOKUP HISTÓRICO
# =========================
HIST_CSV = os.path.expanduser("data/by_game/ballon_wheel.csv")
