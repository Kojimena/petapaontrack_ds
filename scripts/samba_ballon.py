...
# 1) CARGA MODELO
# =========================
bundle = joblib.load(os.path.expanduser("data_analysis/models/samba_ballon.joblib"))
...
# 2) LOOKUP HISTÓRICO
# =========================
HIST_CSV = os.path.expanduser("data/by_game/samba_ballon.csv")
