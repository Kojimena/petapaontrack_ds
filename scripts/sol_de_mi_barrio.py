...
# 1) CARGA MODELO
# =========================
bundle = joblib.load(os.path.expanduser("data_analysis/models/sol_de_mi_barrio.joblib"))
...
# 2) LOOKUP HISTÓRICO
# =========================
HIST_CSV = os.path.expanduser("data/by_game/sol_de_mi_barrio.csv")
