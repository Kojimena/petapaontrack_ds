...
# 1) CARGA MODELO
# =========================
bundle = joblib.load(os.path.expanduser("data_analysis/models/tronco_splash.joblib"))
...
# 2) LOOKUP HISTÓRICO
# =========================
HIST_CSV = os.path.expanduser("data/by_game/tronco_splash.csv")
